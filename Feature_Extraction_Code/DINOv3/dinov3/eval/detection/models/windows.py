...
# from torchvision.transforms import v2  # Commented out due to compatibility issue
try:
    ...
    class V2Fallback:
        class functional:
            ...
            def crop(img, top, left, height, width):
                return F_tv.crop(img, top, left, height, width)
            
            @staticmethod
            def resize(img, size, interpolation=F_tv.InterpolationMode.BILINEAR):
                return F_tv.resize(img, size, interpolation)
    v2 = V2Fallback()
